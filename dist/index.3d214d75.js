...
class MyComponent extends (0, _lit.LitElement) {
  ...
  `;
    ...
    lerpToWhole() {
        ...
        const lerp = ()=>{
            ...
            if (Math.abs(this.offset - target) < 0.001) this.offset = target;
            else requestAnimationFrame(lerp);
        };
        lerp();
    }
    track(event) {
    ...
    render() {
      ...
      <div style="font-size: ${this.childHeight * 0.9}px" class="container" @mousedown="${()=>this.startTracking()}">
        ...
        ${this.symbolsList.map((symbol, index)=>(0, _lit.html)`
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["km5uZ","bB7Pu"], "bB7Pu", "parcelRequire6103")
